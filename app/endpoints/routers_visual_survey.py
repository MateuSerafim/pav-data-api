...
from app.dependences import visual_stretch_service
...
async def create_visual_survey(road_strech_id: uuid.UUID, date: datetime,
                                visual_survey_service: VisualSurveyService\
                                  = Depends(visual_stretch_service)):
    ...
    return return_response(add_result, VisualSurveyResponse)
...
async def get_visual_surveys(road_strech_id: uuid.UUID, 
    ...
    return return_response(query_result, VisualSurveyResponse)